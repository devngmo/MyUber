...
import (
	...
	// APIs
	"skaffolder/MyUber/api/MyUber_db/booking"
	"skaffolder/MyUber/api/MyUber_db/car"
	"skaffolder/MyUber/api/MyUber_db/driver"
	"skaffolder/MyUber/api/MyUber_db/track"
	"skaffolder/MyUber/api/MyUber_db/user"
...
func Routes(configuration *config.Config) *chi.Mux {
	...
	router.Route("/api", func(r chi.Router) { 
		...
		r.Mount("/booking", booking.New(configuration).Routes())
		r.Mount("/car", car.New(configuration).Routes())
		r.Mount("/driver", driver.New(configuration).Routes())
		r.Mount("/track", track.New(configuration).Routes())
